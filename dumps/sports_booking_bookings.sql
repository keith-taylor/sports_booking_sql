...
CREATE TABLE `bookings` (
  ...
  KEY `fk1` (`member_id`),
  CONSTRAINT `fk1` FOREIGN KEY (`member_id`) REFERENCES `members` (`member_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk2` FOREIGN KEY (`room_id`) REFERENCES `rooms` (`room_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2022-10-06 19:34:04
